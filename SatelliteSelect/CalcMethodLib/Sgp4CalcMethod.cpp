...
/////////////////////////////////////////////////////////////////////////////////////
bool Sgp4CalcMethod::SGP4(double tsince,int iFlag, tagVECTOR& pos, tagVECTOR& vel)
{
//  label
...
bool Sgp4CalcMethod::Deep(int ideep)
{
//  const
...
//Call_dpinit
void Sgp4CalcMethod::Call_dpinit(double *eosq,double *sinio,double *cosio,double *betao,double *aodp,
...
void Sgp4CalcMethod::Call_dpsec( double *xmdf,double *omgadf,double *xnode,double *emm,double *xincc,
...
void Sgp4CalcMethod::Call_dpper(double *e,double *xincc,double *omgadf,double *xnode,double *xmam)
{
...
bool Sgp4CalcMethod::SDP4(double tsince, int iFlag, tagVECTOR& pos, tagVECTOR& vel)
{
//  label
//    9,10,90,100,130,140;
//  const
